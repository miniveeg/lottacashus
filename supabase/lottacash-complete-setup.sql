...
-- 10e. cb_claim_payout — 2-arg only (amount recomputed server-side).
-- Implements all gamemodes (standard/group/terminal/jackpot) + crazy flip.
create or replace function public.cb_claim_payout(
  p_battle_id uuid,
  p_slot int
)
...
-- ══════════════════════════════════════════════════════════════════════════════
-- PRODUCTION PHASE 003+004 (mines coin lock, deposit USD limits, CB payouts,
-- blackjack coin_type). Safe to re-run: uses CREATE OR REPLACE / IF NOT EXISTS.
-- ══════════════════════════════════════════════════════════════════════════════
begin;
